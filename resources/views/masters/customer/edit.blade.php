...
<div class="card">
    <div class="card-body">
        ...
        <div class="tab-content" id="myTabContent">
            <div class="table-panel fade show active" id="basic-info" role="tabpanel" aria-labelledby="basic-info-tab">
                <div class="row mb-4 mt-3">
                    <div class="form-group col-md-5">
                        <label for="aadhar_number"><b>Enter Aadhar Number</b></label>
                        <input type="text" class="form-control" id="aadhar_number" placeholder="Enter Aadhar Number">
                    </div>
            ...
            <div class="table-panel fade" id="kyc" role="tabpanel" aria-labelledby="kyc-tab">
                <div class="row mb-4 mt-3">
                    <div class="form-group col-md-5">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="file" class="form-control" id="aadhar_attachment">
                    </div>
                </div>
                <div class="row mb-4 mt-3">
                    <div class="form-group col-md-5">
                    ...
                    <div class="form-group col-md-5">
                        ...
                        <input type="file" class="form-control" id="pan_attachment">
                    </div>
                </div>
            </div>
            <div class="tabel-panel fade" id="loans" role="tabpanel" aria-labelledby="loans-tab">
                <div class="row gy-3">
                    <div class="col-md-12">
