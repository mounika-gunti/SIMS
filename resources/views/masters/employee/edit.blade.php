...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('employee.update', $employee->id) }}" method="PUT" enctype="multipart/form-data">
            @csrf
                        ...
                        <div class="row gy-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control w-3" name="aadhar_number" id="aadhar_number"
                                    value="{{ $employee->aadhar_number }}" placeholder="Enter Aadhar Number">
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control w-3" name="pan_number" id="pan_number"
                                    value="{{ $employee->pan_number }}" placeholder="Enter PAN Number">
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                    ...
                    <div class="row p-3">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control w-3" name="bank_name" id="bank_name"
                                value="{{ $employee->bank_name }}" placeholder="Enter Bank Name">
                        </div>
                        <div class="col-md-6">
                            <label for="branch_name" class="form-label">Branch Name*</label>
                            <input type="text" class="form-control w-3" name="branch_name" id="branch_name"
                                value="{{ $employee->branch_name }}" placeholder="Enter Branch Name">
                        </div>
                        <div class="col-md-6">
                            <label for="ifsc" class="form-label">IFSC*</label>
                            <input type="text" class="form-control w-3" name="ifsc" id="ifsc"
                                value="{{ $employee->ifsc }}" placeholder="Enter IFSC">
                        </div>
                        <div class="col-md-6">
                            <label for="account_no" class="form-label">Account Number*</label>
                            <input type="text" class="form-control w-3" name="account_no" id="account_no"
                                value="{{ $employee->account_no }}" placeholder="Enter Account Number">
                        </div>
                        <div class="form-row mb-4">
                            <div class="col-md-12 d-flex justify-content-end">
                    ...
                    <div class="row gy-3 p-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_name"
                                id="emergency_contact_name" value="{{ $employee->emergency_contact_name }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_phone_number"
                                ...
                                value="{{ $employee->emergency_contact_phone_number }}"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_relationship"
                                ...
                                value="{{ $employee->emergency_contact_relationship }}" placeholder="Enter Relation">
                        </div>
                        <div class="form-row mb-4">
                            <div class="col-md-12 d-flex justify-content-end">
                                <div class="form-group mb-2 mr-3">
