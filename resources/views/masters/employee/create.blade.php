                ...
                <div class="tab-pane fade" id="bankDetails-pane" role="tabpanel" aria-labelledby="bankDetails-tab">
                    <div class="row p-3">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="ifsc" id="ifsc" placeholder="Enter IFSC">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row gy-3 p-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_name"
                                id="emergency_contact_name" placeholder="Enter Name">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_phone_number"
                                id="emergency_contact_phone_number" placeholder="Enter Phone Number">
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control w-3" name="emergency_contact_relationship"
                                id="emergency_contact_relationship" placeholder="Enter Relation">
                        </div>
                        <div class="form-row mb-4">
                            <div class="col-md-12 d-flex justify-content-end">
                                <div class="form-group mb-2 mr-3">
